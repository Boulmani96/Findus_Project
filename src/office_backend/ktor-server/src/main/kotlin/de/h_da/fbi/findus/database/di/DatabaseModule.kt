...
const val mongo_URI_TEST = "MONGO_URI_TEST"
const val socketTimeOut = 3
const val clusterTimeOut: Long = 1

fun databaseModule(isTesting: Boolean = false) = module {
    factory {
        ...
        val connectionString = if (isTesting) {
